...
export const CLIENT_CONTRACT_ABI = [
  ...
  {
    type: "error",
    name: "InvalidMetaAllocatorContractAddress",
    inputs: [],
  },
  {
    type: "error",
  ...
  {
    type: "error",
    name: "InvalidPoRepMarketContractAddress",
    inputs: [],
  },
  {
    type: "error",
